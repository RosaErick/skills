...
1. **Who is it going to?** Reuse the recipient's role, expertise and relationship already provided; ask only for missing context that changes the questions. This fixes the questionnaire's tone and how much context it must carry. Done when you know who the recipient is and what they know that the user doesn't.

2. **What do you need back?** Use the known goal and identify the specific facts or decisions the recipient can resolve. Ask only about a remaining material gap. Done when you have a concrete list of what the user must walk away able to do or decide.
