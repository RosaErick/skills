...
- Working on UI/UX design tasks or workflows
- Needing guidance, best practices, or checklists for interface design
- Creating or reviewing design systems, user flows, or component libraries
- Evaluating accessibility compliance or inclusive design
...
- Clarify goals, constraints, and required inputs before designing.
- Apply relevant best practices and validate outcomes.
- Provide actionable steps and verification.
- Prioritize accessibility and user-centered decisions in every output.
...
- Native mobile app design (iOS HIG, Material Design)
...
2. **Design systematically** — use tokens and reusable components
3. **Prioritize accessibility** — inclusive design from concept stage
4. **Document decisions** — clear rationale and usage guidelines
...
8. **Measure design impact** — optimize for continuous improvement
