---
name: frontend-design-mitsuhiko
...
<!-- Modified for this collection: renamed the skill to frontend-design-mitsuhiko to preserve other installed frontend-design skills without a name collision. Instructions remain unchanged. -->
