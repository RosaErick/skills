...
React, Next.js, CSS and interface work.

## React / Next.js

- **[react-patterns](./react-patterns/SKILL.md)** — React 18/19 components and hooks: state placement, effects, composition, React Compiler, TypeScript props.
- **[react-best-practices](./react-best-practices/SKILL.md)** — 45 React/Next.js performance rules from Vercel Engineering, ranked by impact.
- **[react-ui-patterns](./react-ui-patterns/SKILL.md)** — Loading states, error handling and data fetching in components.
...
- **[web-performance-optimization](./web-performance-optimization/SKILL.md)** — Core Web Vitals, bundle size, caching, runtime performance.
- **[i18n-localization](./i18n-localization/SKILL.md)** — Hardcoded strings, locale files, translations, RTL support.
